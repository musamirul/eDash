      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbar">
          <ul class="navbar-nav">
            ...
            <!-- Nav Bar -->
            <li class="nav-item">
              <a class="nav-link " href="paparborangmaklumat.php">Update Information</a>
            </li>

            <li class="nav-item">
              <a class="nav-link " href="displayPortal.php">Display Information</a>
            </li>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="card mb-3">
      ...
      <div class="row">
        <div class="col-sm-12">
          <a class="btn btn-info " href="borang/update_form.php?id_user=<?php echo $maklumat["id_user"];?>">UPDATE</a>
        </div>
      </div>
<!-- <hr> -->
<!-- <div class="row">
...
<a class="btn btn-info " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Edit</a>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12">
          <a class="btn btn-info " href="borang/borang_update.php?id_user=<?php echo $maklumat["id_user"];?>">UPDATE</a>
        </div>
      </div>      
    </div>
  </div>
  <div class="row">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                    <td><?= $cnt; ?></td>
                    <td><?= $maklumat2['onleave']; ?></td>
                    <td><?= $maklumat2['date1']; ?></td>
                    <td><?= $maklumat2['date2']; ?></td>
                    <td><?= $maklumat2['cover']; ?></td> 
                    </tr>
            <?php 
            $cnt=$cnt+1;
        ...
        <div class="row">
            <div class="col-sm-12">
                <a class="btn btn-primary float-end" href="createOnleave.php" >Create New User</a>
            </div>
        </div> 
                    </div>
                </div>
 ...
 ?>
  ...
  <div class="text-center p-3" style="background-color: hsla(0, 0%, 0%, 0.2);">
    © 2023 Copyright: <a href=""> Accident & Emergency KPJ Klang Specialist Hospital</a>
  </div>
  <!-- Copyright -->
</footer>
</html>
